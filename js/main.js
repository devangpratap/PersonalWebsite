...
"use strict";
    ...
    $(function () {
        ...
        $('#contact_form').on('submit', function (e) {
            e.preventDefault();
            var alertBox = '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Thanks for reaching out! I\'ll get back to you soon.</div>';
